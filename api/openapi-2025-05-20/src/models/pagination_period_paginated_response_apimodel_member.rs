...
pub struct PaginationPeriodPaginatedResponseApimodelMember {
    /// The list of items in the current result set
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ApimodelPeriodMember>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::PaginationPeriodPaginationMeta>>,
}

impl PaginationPeriodPaginatedResponseApimodelMember {
    pub fn new() -> PaginationPeriodPaginatedResponseApimodelMember {
        PaginationPeriodPaginatedResponseApimodelMember {
            data: None,
            pagination: None,
        }
    }
