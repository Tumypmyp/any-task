...
pub struct ApimodelPeriodMemberResponse {
    #[serde(rename = "member", skip_serializing_if = "Option::is_none")]
    pub member: Option<Box<models::ApimodelPeriodMember>>,
}

impl ApimodelPeriodMemberResponse {
    pub fn new() -> ApimodelPeriodMemberResponse {
