...
pub struct ApimodelPeriodMultiSelectPropertyValue {
    ...
    pub multi_select: Option<Vec<models::ApimodelPeriodTag>>,
...
impl ApimodelPeriodMultiSelectPropertyValue {
    pub fn new() -> ApimodelPeriodMultiSelectPropertyValue {
