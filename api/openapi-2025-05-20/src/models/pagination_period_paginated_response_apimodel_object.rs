...
pub struct PaginationPeriodPaginatedResponseApimodelObject {
    /// The list of items in the current result set
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ApimodelPeriodObject>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::PaginationPeriodPaginationMeta>>,
}

impl PaginationPeriodPaginatedResponseApimodelObject {
    pub fn new() -> PaginationPeriodPaginatedResponseApimodelObject {
