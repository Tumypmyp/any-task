...
pub struct ApimodelPeriodSelectPropertyValue {
    ...
    pub select: Option<Box<models::ApimodelPeriodTag>>,
}

impl ApimodelPeriodSelectPropertyValue {
    pub fn new() -> ApimodelPeriodSelectPropertyValue {
