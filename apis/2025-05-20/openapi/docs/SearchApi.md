...
> models::PaginationPaginatedResponseApimodelObject search_global(anytype_version, apimodel_search_request, offset, limit)
...
**apimodel_search_request** | [**ApimodelSearchRequest**](ApimodelSearchRequest.md) | The search parameters used to filter and sort the results | [required] |
...
> models::PaginationPaginatedResponseApimodelObject search_space(anytype_version, space_id, apimodel_search_request, offset, limit)
