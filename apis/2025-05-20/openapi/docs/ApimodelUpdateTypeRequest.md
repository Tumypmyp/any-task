...
**layout** | Option<[**models::ApimodelTypeLayout**](apimodel.TypeLayout.md)> |  | [optional]
...
**properties** | Option<[**Vec<models::ApimodelPropertyLink>**](apimodel.PropertyLink.md)> | ⚠ Warning: Properties are experimental and may change in the next update. ⚠ The properties to set for the type | [optional]
