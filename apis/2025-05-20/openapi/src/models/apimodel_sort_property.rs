...
/// ApimodelSortProperty : The key of the property to sort the search results by
/// The key of the property to sort the search results by
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ApimodelSortProperty {
...
impl std::fmt::Display for ApimodelSortProperty {
...
impl Default for ApimodelSortProperty {
    fn default() -> ApimodelSortProperty {
        Self::CreatedDate
    }
}
