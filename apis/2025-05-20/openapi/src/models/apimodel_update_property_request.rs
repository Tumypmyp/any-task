...
pub struct ApimodelUpdatePropertyRequest {
...
impl ApimodelUpdatePropertyRequest {
    pub fn new(name: String) -> ApimodelUpdatePropertyRequest {
        ApimodelUpdatePropertyRequest {
            key: None,
            name,
        }
    }
