...
impl ApimodelSearchRequest {
    pub fn new() -> ApimodelSearchRequest {
        ApimodelSearchRequest {
            query: None,
            sort: None,
            types: None,
        }
