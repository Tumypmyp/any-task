...
/// PaginationPaginationMeta : The pagination metadata for the response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PaginationPaginationMeta {
...
impl PaginationPaginationMeta {
    /// The pagination metadata for the response
    pub fn new() -> PaginationPaginationMeta {
