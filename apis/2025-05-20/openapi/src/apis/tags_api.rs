...
pub async fn create_tag(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str, apimodel_create_tag_request: models::ApimodelCreateTagRequest) -> Result<models::ApimodelTagResponse, Error<CreateTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
    let p_body_apimodel_create_tag_request = apimodel_create_tag_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_create_tag_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApimodelTagResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApimodelTagResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_tag(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str, tag_id: &str) -> Result<models::ApimodelTagResponse, Error<DeleteTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
...
pub async fn get_tag(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str, tag_id: &str) -> Result<models::ApimodelTagResponse, Error<GetTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
...
pub async fn list_tags(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str) -> Result<models::PaginationPaginatedResponseApimodelTag, Error<ListTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginationPaginatedResponseApimodelTag`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginationPaginatedResponseApimodelTag`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_tag(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str, tag_id: &str, apimodel_update_tag_request: models::ApimodelUpdateTagRequest) -> Result<models::ApimodelTagResponse, Error<UpdateTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
    let p_path_tag_id = tag_id;
    let p_body_apimodel_update_tag_request = apimodel_update_tag_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_update_tag_request);
