...
pub async fn create_object(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, apimodel_create_object_request: models::ApimodelCreateObjectRequest) -> Result<models::ApimodelObjectResponse, Error<CreateObjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_body_apimodel_create_object_request = apimodel_create_object_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_create_object_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApimodelObjectResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApimodelObjectResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_object(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, object_id: &str) -> Result<models::ApimodelObjectResponse, Error<DeleteObjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
...
pub async fn get_object(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, object_id: &str, format: Option<&str>) -> Result<models::ApimodelObjectResponse, Error<GetObjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_object_id = object_id;
...
pub async fn list_objects(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, offset: Option<i32>, limit: Option<i32>) -> Result<models::PaginationPaginatedResponseApimodelObject, Error<ListObjectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
...
pub async fn update_object(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, object_id: &str, apimodel_update_object_request: models::ApimodelUpdateObjectRequest) -> Result<models::ApimodelObjectResponse, Error<UpdateObjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_object_id = object_id;
    let p_body_apimodel_update_object_request = apimodel_update_object_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_update_object_request);
