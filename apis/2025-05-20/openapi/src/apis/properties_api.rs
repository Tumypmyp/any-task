...
pub async fn create_property(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, apimodel_create_property_request: models::ApimodelCreatePropertyRequest) -> Result<models::ApimodelPropertyResponse, Error<CreatePropertyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_body_apimodel_create_property_request = apimodel_create_property_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_create_property_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApimodelPropertyResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApimodelPropertyResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_property(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str) -> Result<models::ApimodelPropertyResponse, Error<DeletePropertyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
...
pub async fn get_property(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str) -> Result<models::ApimodelPropertyResponse, Error<GetPropertyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
...
pub async fn list_properties(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, offset: Option<i32>, limit: Option<i32>) -> Result<models::PaginationPaginatedResponseApimodelProperty, Error<ListPropertiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginationPaginatedResponseApimodelProperty`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginationPaginatedResponseApimodelProperty`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_property(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, property_id: &str, apimodel_update_property_request: models::ApimodelUpdatePropertyRequest) -> Result<models::ApimodelPropertyResponse, Error<UpdatePropertyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
    let p_path_space_id = space_id;
    let p_path_property_id = property_id;
    let p_body_apimodel_update_property_request = apimodel_update_property_request;
    ...
    req_builder = req_builder.json(&p_body_apimodel_update_property_request);
