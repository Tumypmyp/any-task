...
pub struct PaginatedResponseProperty {
    /// The list of items in the current result set
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::Property>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::PaginationMeta>>,
}

impl PaginatedResponseProperty {
    pub fn new() -> PaginatedResponseProperty {
        PaginatedResponseProperty {
            data: None,
            pagination: None,
        }
    }
