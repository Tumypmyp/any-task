...
pub async fn search_global(configuration: &configuration::Configuration, anytype_version: &str, search_request: models::SearchRequest, offset: Option<i32>, limit: Option<i32>) -> Result<models::PaginatedResponseObject, Error<SearchGlobalError>> {
...
pub async fn search_space(configuration: &configuration::Configuration, anytype_version: &str, space_id: &str, search_request: models::SearchRequest, offset: Option<i32>, limit: Option<i32>) -> Result<models::PaginatedResponseObject, Error<SearchSpaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_anytype_version = anytype_version;
