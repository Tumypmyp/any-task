...
> models::TypeResponse create_type(anytype_version, space_id, create_type_request)
Create type
...
**create_type_request** | [**CreateTypeRequest**](CreateTypeRequest.md) | The type to create | [required] |

### Return type

[**models::TypeResponse**](TypeResponse.md)
...
> models::TypeResponse delete_type(anytype_version, space_id, type_id)
Delete type
...
> models::TypeResponse get_type(anytype_version, space_id, type_id)
Get type
...
[**models::PaginatedResponseType**](PaginatedResponse-Type.md)
...
> models::TypeResponse update_type(anytype_version, space_id, type_id, update_type_request)
Update type
...
**update_type_request** | [**UpdateTypeRequest**](UpdateTypeRequest.md) | The type details to update | [required] |
