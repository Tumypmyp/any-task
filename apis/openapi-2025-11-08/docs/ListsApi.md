...
> String add_list_objects(anytype_version, space_id, list_id, add_objects_to_list_request)
Add objects to list
...
**add_objects_to_list_request** | [**AddObjectsToListRequest**](AddObjectsToListRequest.md) | The list of object IDs to add to the list; must be retrieved from SearchSpace or GlobalSearch endpoints or obtained from response context | [required] |
...
> models::PaginatedResponseObject get_list_objects(anytype_version, space_id, list_id, view_id, offset, limit)
Get objects in list
...
> models::PaginatedResponseView get_list_views(anytype_version, space_id, list_id, offset, limit)
Get list views
...
[**models::PaginatedResponseView**](PaginatedResponse-View.md)
