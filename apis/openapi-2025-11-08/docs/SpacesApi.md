...
> models::SpaceResponse create_space(anytype_version, create_space_request)
Create space
...
**create_space_request** | [**CreateSpaceRequest**](CreateSpaceRequest.md) | The space to create | [required] |

### Return type

[**models::SpaceResponse**](SpaceResponse.md)
...
> models::SpaceResponse get_space(anytype_version, space_id)
Get space
...
> models::PaginatedResponseSpace list_spaces(anytype_version, offset, limit)
List spaces
...
[**models::PaginatedResponseSpace**](PaginatedResponse-Space.md)
...
> models::SpaceResponse update_space(anytype_version, space_id, update_space_request)
Update space
...
**update_space_request** | [**UpdateSpaceRequest**](UpdateSpaceRequest.md) | The space details to update | [required] |
