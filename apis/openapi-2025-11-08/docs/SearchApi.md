...
> models::PaginatedResponseObject search_global(anytype_version, search_request, offset, limit)
...
**search_request** | [**SearchRequest**](SearchRequest.md) | The search parameters used to filter and sort the results | [required] |
...
> models::PaginatedResponseObject search_space(anytype_version, space_id, search_request, offset, limit)
