...
> models::TemplateResponse get_template(anytype_version, space_id, type_id, template_id)
Get template
...
> models::PaginatedResponseObject list_templates(anytype_version, space_id, type_id, offset, limit)
List templates
