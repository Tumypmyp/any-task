...
> models::TagResponse create_tag(anytype_version, space_id, property_id, create_tag_request)
Create tag
...
**create_tag_request** | [**CreateTagRequest**](CreateTagRequest.md) | The tag to create | [required] |

### Return type

[**models::TagResponse**](TagResponse.md)
...
> models::TagResponse delete_tag(anytype_version, space_id, property_id, tag_id)
Delete tag
...
> models::TagResponse get_tag(anytype_version, space_id, property_id, tag_id)
Get tag
...
> models::PaginatedResponseTag list_tags(anytype_version, space_id, property_id)
List tags
...
[**models::PaginatedResponseTag**](PaginatedResponse-Tag.md)
...
> models::TagResponse update_tag(anytype_version, space_id, property_id, tag_id, update_tag_request)
Update tag
...
**update_tag_request** | [**UpdateTagRequest**](UpdateTagRequest.md) | The tag to update | [required] |
